...
%% add additional side frequencies 
fluteFM = fluteFM + 0.02*sin(2*pi*fm*3*t).*A;
fluteFM = fluteFM + 0.01*sin(2*pi*fm*4*t).*A;
fluteFM = fluteFM + 0.005*sin(2*pi*fm*5*t).*A;
fluteFM = fluteFM + 0.003*sin(2*pi*fm*6*t).*A;
fluteFM = fluteFM + 0.0025*sin(2*pi*fm*7*t).*A;
fluteFM = fluteFM + 0.002*sin(2*pi*fm*8*t).*A;
fluteFM = fluteFM + 0.0015*sin(2*pi*fm*9*t).*A;
fluteFM = fluteFM + 0.001*sin(2*pi*fm*10*t).*A;
fluteFM = fluteFM + 0.001*sin(2*pi*fm*11*t).*A;
...
fluteFM = fluteFM + noise2.*A*0.01;

% add white noise above 10k Hz for better blow sound
noise4 = wgn(1,size(fluteFM,2),0);
noise4 = filter(noisefilterHigh, noise4);
fluteFM = fluteFM + noise4.*A*0.01;
