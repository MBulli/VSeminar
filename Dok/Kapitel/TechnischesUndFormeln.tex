...
Physikalisch gesehen ist ein Ton eine periodische Änderung des Luftdruckt, also Luftmoleküle die um ihre Ruhelage in Schwingung versetzt werden\cite{EinfAkustik}. Als Medium kann jedoch auch etwas anderer als Luft dienen, zum Beispiel Wasser.

Für das menschliche Ohr hören sich Sinus- und Cosinusschwingungen gleich an, da diese lediglich um $\frac{1}{4}$ der Periode verschoben sind. 

\subsubsection{Erklärung: Parameter der FM-Synthese nach Chowning}
