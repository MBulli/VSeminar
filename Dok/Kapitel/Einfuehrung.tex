...
Die Frequenzen der Träger- und Modulationsfunktion wurden so gewählt, dass sie in einem Frequenzbereich liegen, der vom menschlichen Ohr wargenommen werden kann. (Siehe Kapitel ``Menschliches Ohr'').
