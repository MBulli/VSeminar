...
\begin{figure} [ht]
\centering
  \includegraphics[width=0.95\textwidth]{Carrier_Modulator.png}
\caption{Beispiel 1}
\label{fig:beispiel1}
Quelle: Eigene Darstellung mit Matlab
\end{figure}
